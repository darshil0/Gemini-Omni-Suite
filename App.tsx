...
const App: React.FC = () => {
  ...
  const NavItem = ({
    ...
    return (
      ...
      >
          ...
          <div
            className={`p-2 rounded-lg transition-colors ${
              isActive
                ...
                : 'bg-gray-200 dark:bg-gray-800 text-gray-500 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white group-hover:bg-gray-300 dark:group-hover:bg-gray-700'
            }`}
          >
            {icon}
          </div>
        ...
        {isActive && (
          <div className="absolute right-0 top-0 h-full w-1 bg-blue-500 shadow-[0_0_10px_rgba(59,130,246,0.5)]"></div>
        )}
      </button>
    );
  };
  ...
  return (
    <div
      className={`flex h-screen w-full transition-colors duration-500 font-sans
      ${
        theme === 'dark'
      ...
      <aside className="w-20 lg:w-72 glass-panel border-r-0 border-r border-gray-200 dark:border-white/5 flex flex-col p-4 shrink-0 z-20 transition-all duration-300">
        ...
        <div className="mt-auto space-y-4">
          ...
          <div className="glass-panel rounded-xl p-4 border border-gray-200 dark:border-white/5 hidden lg:block relative overflow-hidden">
            ...
            <p className="text-[10px] text-gray-500 dark:text-gray-400 font-bold uppercase tracking-widest mb-2">
              System Status
            </p>
